    ...
    return (
        <div
            className="prose prose-slate lg:prose-lg max-w-full 
                       ...
                       dark:from-slate-800 dark:to-slate-900 p-6 sm:p-8 
        ...
        >
            <ReactMarkdown
                ...
                components={{
                    h1: ({node, ...props}) => <h1 className={`${headingBaseClasses} text-4xl pb-2 mb-4 mt-6 border-b border-slate-300 dark:border-slate-700`} {...props} />,
                    h2: ({node, ...props}) => <h2 className={`${headingBaseClasses} text-3xl pb-2 mb-3 mt-5 border-b border-slate-300 dark:border-slate-700`} {...props} />,
                    h3: ({node, ...props}) => <h3 className={`${headingBaseClasses} text-2xl mb-3 mt-5`} {...props} />,
                    h4: ({node, ...props}) => <h4 className={`${headingBaseClasses} text-xl mb-2 mt-4`} {...props} />,
                    h5: ({node, ...props}) => <h5 className={`${headingBaseClasses} text-lg mb-2 mt-3`} {...props} />,
                    h6: ({node, ...props}) => <h6 className={`${headingBaseClasses} text-base mb-2 mt-3`} {...props} />,
                    p: ({node, ...props}) => <p className="my-4 leading-relaxed text-slate-700 dark:text-slate-300" {...props} />,
                    ...
                    ul: ({node, ...props}) => <ul className="list-disc pl-6 my-4 space-y-2 text-slate-700 dark:text-slate-300" {...props} />,
                    ol: ({node, ...props}) => <ol className="list-decimal pl-6 my-4 space-y-2 text-slate-700 dark:text-slate-300" {...props} />,
                    ...
                    thead: ({ node, children, ...props }) => <thead className="bg-slate-100 dark:bg-slate-800" {...props}>{children}</thead>,
                    ...
                    // You can add more custom components for strong, em, etc. if needed
