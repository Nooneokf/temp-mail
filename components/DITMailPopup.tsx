        ...
        <div className="fixed bottom-5 right-5 z-40 p-5 max-w-sm w-full bg-white dark:bg-gray-800 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700 transform transition-all duration-300 ease-out animate-slide-in-up">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-2">
              ...
              <Link href="/blog/introducing-ditmail-pro">
                <a 
                  onClick={handleDismissPopup}
                  className="w-full sm:w-auto px-4 py-2 text-sm text-center font-semibold text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200 dark:text-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                >
                  Read More
                </a>
              </Link>
